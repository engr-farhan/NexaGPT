...
const SpeakSetting = () => {
  ...
  const [testContent, setTestContent] = useState(
    "I am Farhan and I created this application.You can copy and paste this sentence into your text-to-speech application to hear how it sounds with different voices and rates."
  );
  return (
    <Fragment>
      <IconButton
